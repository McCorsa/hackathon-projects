...
<main class="max-w-screen-lg mx-auto flex flex-col justify-center h-screen text-center text-white gap-2 items-center">
    <h1 class="text-5xl font-bold text-primary">The Code Network 2023 Winter Hackathon is now closed.</h1>
    <h2 class="text-2xl font-semibold">We look forward to seeing you again next year!</h2>
    <div class="flex flex-row gap-3 items-center mt-4">
        <span>Our Socials:</span>
        <a href="https://codenetwork.co" class="text-gray-300 hover:text-primary">
        ...
        <a href="https://facebook.com/CodeNetwork" class="text-gray-300 hover:text-primary">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
            </svg>
        </a>
        <a href="https://www.instagram.com/codenetwork_/" class="text-gray-300 hover:text-primary">
        ...
        <span class="ml-8">Source Code:</span>
        <a href="https://github.com/McCorsa/hackathon-projects" class="text-gray-300 hover:text-primary">
